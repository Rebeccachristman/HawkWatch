...
column_name_list = ['NumObj' 'TimeDiff1' 'TimeDiff2' 'TimeDiff3' 'area' 'filled_area'
 'mean_intensity1' 'mean_intensity2' 'orientation' 'EagleLabel' 'median1'
 'std1' 'skew1' 'median2' 'std2' 'skew2' 'moments_hu_0' 'moments_hu_1'
 'moments_hu_2' 'moments_hu_3' 'moments_hu_4' 'moments_hu_5'
 'moments_hu_6']
...
def main(argv):
   ...
   #   #opts, args = getopt.getopt(argv,"hi:o:",["imagedir=","ofile="])
    ...
    df_seq = pd.DataFrame(columns=column_name_list)

    df_seq = df_data.drop(columns=['Dir',  'Camera', 'ROI', 'Datetime', 'Image1', 'Image2', 'SeqNum', 'SeqLen', 'Night', 'bbox', 'centroid', 'regionID', 'hist1', 'hist2', 'moments_hu', 'weighted_moments_hu1', 'weighted_moments_hu2'])
    #df_seq = df_seq.drop(columns=['moments_hu', 'weighted_moments_hu1', 'weighted_moments_hu2'])
    ...
    df_label_predicted = pd.DataFrame(data=label_predicted, columns=['EagleLabel'])
